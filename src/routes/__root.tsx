    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="btn-base bg-secondary text-secondary-foreground">
            Go home
          </a>
        </div>
      </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "MzansiTalk — South Africa's Social App" },
      {
        name: "description",
        content:
          "MzansiTalk is a free members-only social app for posts, reels and status. Sign up to watch, share and boost your content.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#8E24AA" },
    ],
    links: [
